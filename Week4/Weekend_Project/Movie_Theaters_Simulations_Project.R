    ...
    ggplot(data=theater_one_employee_evaluation, aes(x=Evaluation)) + geom_bar(fill="steelblue") +
    ...
    ggplot(data=theater_two_employee_evaluation, aes(x=Evaluation)) + geom_bar(fill="steelblue") +
